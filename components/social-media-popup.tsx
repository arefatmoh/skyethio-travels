  ...
  return (
    <div className="fixed bottom-5 right-5 z-50">
      ...
      <button
        ...
        aria-label={t("components.socialMediaPopup.toggleButton")}
      >
      ...
      >
        <div className="relative rounded-2xl border border-white/20 bg-white/10 backdrop-blur-xl shadow-2xl overflow-hidden">
          ...
          <div className="flex items-center justify-between px-4 pt-4">
            <div>
              <h3 className="text-white font-playfair font-bold text-lg leading-none">{t("components.socialMediaPopup.title")}</h3>
              <p className="text-xs text-white/70 font-poppins">{t("components.socialMediaPopup.subtitle")}</p>
            </div>
            <button
              ...
              aria-label={t("components.socialMediaPopup.closeButton")}
            >
              <X className="h-5 w-5" />
            </button>
          </div>
          ...
          <div className="p-4 space-y-3">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="leading-tight">
                  <div className="font-poppins font-semibold">{t("components.socialMediaPopup.whatsapp")}</div>
                  <div className="text-xs text-white/70">{t("components.socialMediaPopup.whatsappSubtitle")}</div>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="leading-tight">
                  <div className="font-poppins font-semibold">{t("components.socialMediaPopup.telegram")}</div>
                  <div className="text-xs text-white/70">{t("components.socialMediaPopup.telegramSubtitle")}</div>
                </div>
              </div>
          ...
          {/* Footer */}
          <div className="px-4 pb-4 text-[11px] text-white/70 font-poppins">{t("components.socialMediaPopup.footer")}</div>
        </div>
      </div>
    </div>
  );
